...
local function toggleFreelookLock()
...
local savePermBtn = Instance.new("TextButton")
...
--------------------------------------------------------------------------------
local function selectAnimation(item)
...
-- Forward declarations for controls referenced by Section 9 event listeners
...
local function createModeCard(parent, xPos, title, badge, desc, accentCol, onClick)
	local card = Instance.new("Frame")
